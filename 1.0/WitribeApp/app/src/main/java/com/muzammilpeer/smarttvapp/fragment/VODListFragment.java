...
import com.muzammilpeer.smarttvapp.cell.VodListCell;
...
//        params[1] = "4";
        ...
        WitribeAMFRequest request = new WitribeAMFRequest(null, NetworkRequestEnum.GET_VODS_CATEGORIES);
        try {
...
//        params[1] = "4";
        ...
        WitribeAMFRequest request = new WitribeAMFRequest(params, NetworkRequestEnum.GET_VODS_SUB_CATEGORIES);
        try {
            NetworkManager.getInstance().executeRequest(request, this);
