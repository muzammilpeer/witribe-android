...
import com.muzammilpeer.pakistanitv.adapter.ChannelsCategoryViewPagaerAdapter;
...
public class MainActivityFragment extends BaseFragment {
    ...
    private void getChannelsDataRequest() {
        ...
        WitribeGeneralRequest request = new WitribeGeneralRequest(null, NetworkRequestEnum.GET_CHANNELS);
        try {
            NetworkManager.getInstance().executeRequest(request, this);
