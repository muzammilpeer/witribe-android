...
import com.muzammilpeer.pakistanitv.cell.EducationListCell;
...
//        params[1] = "4";
        ...
        WitribeGeneralRequest request = new WitribeGeneralRequest(params, NetworkRequestEnum.GET_INNER_MENU);
        try {
            NetworkManager.getInstance().executeRequest(request, this);
    ...
    private void getVODSubCategoryListData(String id, String id_category) {
        ...
        WitribeGeneralRequest request = new WitribeGeneralRequest(params, NetworkRequestEnum.GET_RELEVANT_VIDEOS_BY_ID);
        try {
            NetworkManager.getInstance().executeRequest(request, this);
