...
public class LoginFragment extends BaseFragment implements View.OnClickListener {
    ...
    private void loginDataRequest() {
        ...
        WitribeGeneralRequest request = new WitribeGeneralRequest(params, NetworkRequestEnum.LOGIN_WITRIBE_USER);
        try {
                ...
                switch (request.getNetworkRequestEnum()) {
                    ...
                    case LOGIN_WITRIBE_USER: {
                        ...
                        if (model.getData().response.getToken().length() > 0) {
                            ...
                            Intent intent = new Intent(getBaseActivity(), DashboardAppCompactActivity.class);
