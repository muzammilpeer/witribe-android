...
import com.muzammilpeer.pakistanitv.cell.FavouriteListCell;
...
//        params.setScrollFlags(0);
    ...
    private void getFavouritesData() {
        ...
        WitribeGeneralRequest request = new WitribeGeneralRequest(params, NetworkRequestEnum.GET_FAVOURITE_LISTING);
        try {
